...
export default function About() {
  return (
    <section className="py-24 px-4 md:px-12 max-w-7xl mx-auto relative overflow-hidden">
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[500px] bg-primary/5 blur-[100px] rounded-full pointer-events-none transform-gpu" />
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 relative z-10">
        ...
        >
          ...
          <div className="relative z-10">
            <div className="w-12 h-12 rounded-xl bg-blue-500/10 flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300 transform-gpu">
        ...
        >
          ...
          <div className="relative z-10">
            <div className="w-12 h-12 rounded-xl bg-purple-500/10 flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300 transform-gpu">
